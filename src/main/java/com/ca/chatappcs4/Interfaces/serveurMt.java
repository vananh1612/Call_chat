...
import com.ca.chatappcs4.Connectivity.CennectionClass;
...
public class serveurMt extends Thread
{
    ...
    public void run()
    {
        try
        {
            ...
            {
                Socket s=ss.accept() ;
                int clientNumber = nbrClients.incrementAndGet();  // Tăng và lấy số client
                new Conversation(s, clientNumber).start();
            }
